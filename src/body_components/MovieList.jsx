...
const MovieList = () => {
    ...
    */
    ...
    /* 
    appends favorited movie to sidebar favorites
    */
    ...
    /*
    removes unfavorited movie from sidebar favorites
    */
            ...
            {showSearchPanel ? (
                <>
                    ...
                    <div id="cardSection">
                        ...
                        {showModal ? (
                            <MovieModal name={modalMovie.title} movieID={modalMovie.id} key={`${modalMovie.id}-${Math.random}`} 
                            poster={`https://image.tmdb.org/t/p/w500${modalMovie.poster_path}`} closeModal={closeModal} 
                            release={modalMovie.release_date} overview={modalMovie.overview} />
                        ) : (<></>)}
                    </div>
                </>
            ) : (
                        ...
                        {wantSort ? (
                            <div id="movies">
                                <div id="cardSection">
                                    ...
                                    {showModal ? (
                                        <MovieModal name={modalMovie.title} movieID={modalMovie.id} key={`${modalMovie.id}-${Math.random}`} 
                                        poster={`https://image.tmdb.org/t/p/w500${modalMovie.poster_path}`} closeModal={closeModal} release={modalMovie.release_date} 
